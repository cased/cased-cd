...
const BrandLinkedinFill = forwardRef(
  ({ size = 24, color = "currentColor", ...props }, ref) => {
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("g", { className: "oi-brand-linkedin-fill" }, /* @__PURE__ */ React.createElement(
        "path",
        {
          className: "oi-fill",
...
export default BrandLinkedinFill;
