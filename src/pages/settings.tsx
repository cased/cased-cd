    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto bg-white dark:bg-black">
        <div className="p-8">
          ...
          <div className="mt-8">
            <h2 className="text-lg font-semibold text-black dark:text-white mb-4">General</h2>
            <div className="grid gap-3 md:grid-cols-2">
              <div className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6">
                <h3 className="font-medium text-black dark:text-white mb-2">Appearance</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">Customize the look and feel of your dashboard</p>
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 text-xs font-medium rounded-md bg-neutral-900 border border-neutral-800 text-neutral-400 hover:bg-neutral-800 transition-colors">
                    Light
                  </button>
                  <button className="px-3 py-1.5 text-xs font-medium rounded-md bg-white text-black">
                    Dark
                  </button>
                  <button className="px-3 py-1.5 text-xs font-medium rounded-md bg-neutral-900 border border-neutral-800 text-neutral-400 hover:bg-neutral-800 transition-colors">
                    System
              ...
              <div className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6">
                <h3 className="font-medium text-black dark:text-white mb-2">Notifications</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">Configure how you receive alerts and updates</p>
                <div className="flex flex-col gap-2.5">
                  <label className="flex items-center gap-2.5 text-sm">
                    <input type="checkbox" className="rounded border-neutral-700 bg-neutral-900" defaultChecked />
                    <span className="text-neutral-300 dark:text-neutral-700">Email notifications</span>
                  </label>
                  <label className="flex items-center gap-2.5 text-sm">
                    <input type="checkbox" className="rounded border-neutral-700 bg-neutral-900" defaultChecked />
                    <span className="text-neutral-300 dark:text-neutral-700">Slack notifications</span>
                  </label>
                </div>
              </div>
            </div>
